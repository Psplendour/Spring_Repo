...
public class ClientTest {
	   ...
	   //AbstractApplicationContext context = new ClassPathXmlApplicationContext("BeansNo.xml"); //Mode:no
	    AbstractApplicationContext context = new ClassPathXmlApplicationContext("BeansbyName.xml");//Mode :byName
